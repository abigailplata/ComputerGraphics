...
int MyViewer::handle_keyboard ( const GsEvent &e )
{
	...
	{	case GsEvent::KeyEsc : gs_exit(); return 1;
		...
		case 'q':  c->res++; c->touch(); return 1;
		case 'a':  c->res--; c->touch(); return 1;
		case 'w':  c->r+=0.01f; c->touch(); return 1;
		case 's':  c->r--; c->touch(); return 1;
		case 'e': c->R+=0.01f; c->touch(); return 1;
		case 'd':  c->R--; c->touch(); return 1;
